...
@Component({
  selector: 'SessionWaitlistRespondents',
  templateUrl: './sessionwaitlistrespondents.component.html',
})

export class SessionWaitlistRespondents implements OnInit {
  @Input() id: number;
  ...
  loadData(event: LazyLoadEvent) {
    ...
    console.log(event);
    this.sharedService.getDataWithFilter(event, this.colVisData, this.maxrecords, this.filters, 'sessionStandbyRespondents', this.id)
      .subscribe((resp: any) => {
        // debugger;
  ...
  saveQuery() {
    ...
    this.sharedService.saveQuery('sessionStandbyRespondents', null, '', this.saveQueryName, this.filters)
      .subscribe((res: any) => {
        console.log(res);
        if (res.succeeded) {
