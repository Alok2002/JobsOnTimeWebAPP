...
@Component({
    selector: 'JobPotentialComponent',
    templateUrl: './jobpotential.component.html'
})

export class JobPotentialComponent implements OnInit {
    @Input() id: number;
    ...
    constructor(private jobservice: JobServices, private securityInfoResolve: SecurityInfoResolve,
        private sharedService: SharedServices, private sessionservice: SessionServices,
        private respondentservice: RespondentServices) { }
    ...
    loadData(event: LazyLoadEvent) {
        ...
        console.log(event);
        this.sharedService.getDataWithFilter(event, this.colVisData, this.maxrecords, this.filters, "jobPotentialRespondents", this.id)
            .subscribe((resp: any) => {
                // debugger;
