...
@Component({
  selector: 'StaffKpiReportComponent',
  templateUrl: './staffkpi.component.html'
})

export class StaffKpiReportComponent implements OnInit {
  ...
  public aggregates: any[] = [
    { field: 'totalDays', aggregate: 'sum' },
    { field: 'totalHours', aggregate: 'sum' },
    { field: 'allEventCount', aggregate: 'sum' },
    { field: 'qualifiedEventCount', aggregate: 'sum' },
    { field: 'qualPerHour', aggregate: 'average' },
    { field: 'qualPerEvent', aggregate: 'average' }
  ];
  ...
  /*getStaffKpiReport() {
    this._reportservie.getStaffKpiReport()
      .subscribe(res => {
        this.data = res.value;
  ...
  submitFilter() {
    ...
    this._reportservie.postStaffKpi(this.reports)
      .subscribe((res: any) => {
        this.data = res.value;
        console.log(this.data);
        this.data.forEach((dt) => {
