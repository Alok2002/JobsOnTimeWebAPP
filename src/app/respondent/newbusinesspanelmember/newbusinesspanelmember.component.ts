...
@Component({
  selector: 'NewBusinessPanelMemberComponent',
  templateUrl: './newbusinesspanelmember.component.html'
})

export class NewBusinessPanelMemberComponent implements OnInit {
  selectTab = 'contact';
  //  isLoading = true;
  // resId = 103311;
  resId: number;
